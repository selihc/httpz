...
// for TTLs.
func TestGCRAStore(t *testing.T, st httpthrottle.GCRAStore) {
...
func TestGCRAStoreTTL(t *testing.T, st httpthrottle.GCRAStore) {
	ttl := time.Second
	want := int64(1)
	key := "ttl"
...
func BenchmarkGCRAStore(b *testing.B, st httpthrottle.GCRAStore) {
	seed := int64(42)
