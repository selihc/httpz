// Package memstore offers an in-memory store implementation for httpthrottle.
...
import (
	...
	"selihc.com/glaive/internal/lru"
)

// MemStore is an in-memory store implementation for httpthrottle. It
